...
{
    Properties { _Atlas("Shorelands atlas",2D)="white"{} _WaveScale("Wave scale",Range(0,2))=.18 _FoamDistance("Foam depth",Range(.1,8))=1.5 _FoamTint("Foam tint",Color)=(.9,.95,.84,1) }
    SubShader { Tags { "RenderPipeline"="UniversalPipeline" "Queue"="Transparent" "RenderType"="Transparent" }
        ...
        CBUFFER_START(UnityPerMaterial) half _WaveScale; half _FoamDistance; half4 _FoamTint; CBUFFER_END

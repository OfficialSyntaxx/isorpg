...
- Unity bridge became stale immediately after the asset refresh (`unity@931634bd` remained listed but editor state was stale and Console calls timed out). Therefore no fresh Unity reimport/Play Mode claim is made in this checkpoint; the existing saved scene placement/material/LOD evidence is preserved from the prior checkpoint.
